...
@click.option("--reference", default=None, type=str, help="The branch, tag that will be used to clone the repository")
@click.option("--branch", default=None, type=str, help="The branch name will be used to checkout after clone.")
@click.option("--commit", default=None, type=str, help="The commit hash will be used to checkout after clone.")
@click.option("--tag", default=None, type=str, help="The tag name that will be used to checkout after the clone.")
...
def main(mode, url, branch, commit, tag, reference, output_folder, config, verbose, action_path, workflow_path):
    ...
    if reference:
        option_dict["reference"] = reference
    if mode == "repo":
        if action_path:
